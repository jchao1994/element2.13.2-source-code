...
export default {
  ...
  computed: {
    ...
    ...mapStates({
      selection: "selection", // 获取行选择集
      columns: "columns", // 获取列对象集合
      tableData: "data", // 获取表格数据
      fixedColumns: "fixedColumns", // 获取左侧固定列集合
      rightFixedColumns: "rightFixedColumns", // 获取右侧固定列集合
    }),
  },
